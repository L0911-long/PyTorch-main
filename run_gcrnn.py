...
def run_gcrnn(args):
    ...
    with open("data/model/gcrnn_bj.yaml", 'r', encoding='utf-8') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_filename', default='data/model/gcrnn_bj.yaml', type=str,
                        help='Config file for pretrained model.')
    parser.add_argument('--output_filename', default='data/test_bj_prediction.npz')
